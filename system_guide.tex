...
\documentclass[11pt]{scrartcl} % 12pt font size
...
\definecolor{darkraspberry}{HTML}{8A499D}
\definecolor{darksalmon}{HTML}{9F183B}
\definecolor{weirdyellow}{HTML}{ADB124}
\definecolor{darkteal}{HTML}{089292}
...
\begin{minipage}[t]{125mm} % Create a box to house text

%----------------------------------------------------------------------------------------
%	HEADING ONE
%----------------------------------------------------------------------------------------

\titleformat\sectiontitle{Window manager control}

Client = Application window.\\

\command{Mod4 + d}{Application Launcher}
\command{Mod4 + Enter}{Start terminal}
\command{Mod4 + KP_Enter}{TUI File Manager}
\command{Mod4 + Shift + KP_Enter}{GUI File Manager}
...
\begin{minipage}[t]{125mm} % Create a box to house tex
